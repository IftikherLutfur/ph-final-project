                ...
                <div className="container px-6 py-4 mx-auto md:flex md:justify-between md:items-center">
                    ...
                    <div className="absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-white  md:mt-0 md:p-0 md:top-0 md:relative md:bg-transparent md:w-auto md:opacity-100 md:translate-x-0 md:flex md:items-center">
                        <div className="flex flex-col md:flex-row md:mx-6 uppercase">
                            ...
                            <a className="relative text-gray-700 transition-colors duration-300 transform dark:text-gray-200 hover:text-gray-600
                            dark:hover:text-gray-300" href="#">



                    <NavLink to='dashboard'>
                    <div onClick={handleToGoDashboard} className="flex gap-2 items-center mr-5">
...
<div>
<span className=" top-0 left-0 p-1 text-xs
 text-white bg-blue-500 rounded-full">{cart.length}</span>
</div>
</div>
